...
#include "c6_vipbarcoderecognition_2.h"
...
static void initialize_c6_vipbarcoderecognition_2
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance);
static void initialize_params_c6_vipbarcoderecognition_2
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance);
static void enable_c6_vipbarcoderecognition_2
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance);
static void disable_c6_vipbarcoderecognition_2
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_vipbarcoderecognition_2
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance);
static void set_sim_state_c6_vipbarcoderecognition_2
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance, const mxArray
   *c6_st);
static void finalize_c6_vipbarcoderecognition_2
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance);
static void sf_c6_vipbarcoderecognition_2
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance);
static void initSimStructsc6_vipbarcoderecognition_2
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance);
static void registerMessagesc6_vipbarcoderecognition_2
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static void c6_emlrt_marshallIn(SFc6_vipbarcoderecognition_2InstanceStruct
  *chartInstance, const mxArray *c6_GCode, const char_T *c6_identifier, int32_T
  c6_y[1120]);
static void c6_b_emlrt_marshallIn(SFc6_vipbarcoderecognition_2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  int32_T c6_y[1120]);
static void c6_c_emlrt_marshallIn(SFc6_vipbarcoderecognition_2InstanceStruct
  *chartInstance, const mxArray *c6_LGCode, const char_T *c6_identifier, int32_T
  c6_y[60]);
static void c6_d_emlrt_marshallIn(SFc6_vipbarcoderecognition_2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  int32_T c6_y[60]);
static uint8_T c6_e_emlrt_marshallIn(SFc6_vipbarcoderecognition_2InstanceStruct *
  chartInstance, const mxArray *c6_b_is_active_c6_vipbarcoderecognition_2, const
  char_T *c6_identifier);
static uint8_T c6_f_emlrt_marshallIn(SFc6_vipbarcoderecognition_2InstanceStruct *
  chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_vipbarcoderecognition_2InstanceStruct
  *chartInstance);
  ...
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_vipbarcoderecognition_2 = 0U;
}
  ...
  (SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance)
{
  ...
  c6_h_u = chartInstance->c6_is_active_c6_vipbarcoderecognition_2;
  c6_i_y = NULL;
   ...
   *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_vipbarcoderecognition_2 = c6_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 7)),
     "is_active_c6_vipbarcoderecognition_2");
  sf_mex_destroy(&c6_u);
...
const mxArray *sf_c6_vipbarcoderecognition_2_get_eml_resolved_functions_info
  (void)
{
  ...
  char_T *c6_identifier)
{
  ...
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_vipbarcoderecognition_2), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_vipbarcoderecognition_2);
  return c6_y;
}
...
void sf_c6_vipbarcoderecognition_2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1761934595U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(476436329U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3127866867U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3509893197U);
}

mxArray *sf_c6_vipbarcoderecognition_2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("dkqEJKhN1qaFqXmw7H7pGG");
...
mxArray *sf_c6_vipbarcoderecognition_2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c6_vipbarcoderecognition_2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[14],T\"GCode\",},{M[1],M[20],T\"GCodeRev\",},{M[1],M[13],T\"LCode\",},{M[1],M[19],T\"LCodeRev\",},{M[1],M[16],T\"LGCode\",},{M[1],M[15],T\"RCode\",},{M[1],M[17],T\"RCodeRev\",},{M[8],M[0],T\"is_active_c6_vipbarcoderecognition_2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_vipbarcoderecognition_2_get_check_sum(&mxChecksum);
...
{
  return "wXH3B242K83nM70Uj0hq0";
}

static void sf_opaque_initialize_c6_vipbarcoderecognition_2(void
  *chartInstanceVar)
{
  initialize_params_c6_vipbarcoderecognition_2
    ((SFc6_vipbarcoderecognition_2InstanceStruct*) chartInstanceVar);
  initialize_c6_vipbarcoderecognition_2
    ((SFc6_vipbarcoderecognition_2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_vipbarcoderecognition_2(void *chartInstanceVar)
{
  enable_c6_vipbarcoderecognition_2((SFc6_vipbarcoderecognition_2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c6_vipbarcoderecognition_2(void *chartInstanceVar)
{
  disable_c6_vipbarcoderecognition_2((SFc6_vipbarcoderecognition_2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_vipbarcoderecognition_2(void *chartInstanceVar)
{
  sf_c6_vipbarcoderecognition_2((SFc6_vipbarcoderecognition_2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_vipbarcoderecognition_2
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_vipbarcoderecognition_2
    ((SFc6_vipbarcoderecognition_2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_vipbarcoderecognition_2();/* state var info */
...
extern void sf_internal_set_sim_state_c6_vipbarcoderecognition_2(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c6_vipbarcoderecognition_2
    ((SFc6_vipbarcoderecognition_2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_vipbarcoderecognition_2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c6_vipbarcoderecognition_2(S);
}

static void sf_opaque_set_sim_state_c6_vipbarcoderecognition_2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c6_vipbarcoderecognition_2(S, st);
}

static void sf_opaque_terminate_c6_vipbarcoderecognition_2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_vipbarcoderecognition_2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c6_vipbarcoderecognition_2
      ((SFc6_vipbarcoderecognition_2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_vipbarcoderecognition_2
    ((SFc6_vipbarcoderecognition_2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_vipbarcoderecognition_2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c6_vipbarcoderecognition_2
      ((SFc6_vipbarcoderecognition_2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_vipbarcoderecognition_2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2268918080U));
  ssSetChecksum1(S,(547852625U));
  ssSetChecksum2(S,(1383829662U));
  ssSetChecksum3(S,(610587488U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c6_vipbarcoderecognition_2(SimStruct *S)
{
...
static void mdlStart_c6_vipbarcoderecognition_2(SimStruct *S)
{
  SFc6_vipbarcoderecognition_2InstanceStruct *chartInstance;
  chartInstance = (SFc6_vipbarcoderecognition_2InstanceStruct *)utMalloc(sizeof
    (SFc6_vipbarcoderecognition_2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_vipbarcoderecognition_2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_vipbarcoderecognition_2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_vipbarcoderecognition_2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_vipbarcoderecognition_2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_vipbarcoderecognition_2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_vipbarcoderecognition_2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_vipbarcoderecognition_2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_vipbarcoderecognition_2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_vipbarcoderecognition_2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_vipbarcoderecognition_2;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_vipbarcoderecognition_2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_vipbarcoderecognition_2;
...
void c6_vipbarcoderecognition_2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_vipbarcoderecognition_2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_vipbarcoderecognition_2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_vipbarcoderecognition_2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_vipbarcoderecognition_2_method_dispatcher.\n"
