...
static void initialize_c10_blokowy(SFc10_blokowyInstanceStruct *chartInstance);
static void initialize_params_c10_blokowy(SFc10_blokowyInstanceStruct
  *chartInstance);
static void enable_c10_blokowy(SFc10_blokowyInstanceStruct *chartInstance);
static void disable_c10_blokowy(SFc10_blokowyInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_blokowy(SFc10_blokowyInstanceStruct
  *chartInstance);
static void set_sim_state_c10_blokowy(SFc10_blokowyInstanceStruct *chartInstance,
  const mxArray *c10_st);
static void finalize_c10_blokowy(SFc10_blokowyInstanceStruct *chartInstance);
static void sf_c10_blokowy(SFc10_blokowyInstanceStruct *chartInstance);
static void c10_chartstep_c10_blokowy(SFc10_blokowyInstanceStruct *chartInstance);
static void initSimStructsc10_blokowy(SFc10_blokowyInstanceStruct *chartInstance);
static void registerMessagesc10_blokowy(SFc10_blokowyInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber);
static void c10_check_forloop_overflow_error(SFc10_blokowyInstanceStruct
  *chartInstance, boolean_T c10_overflow);
static void c10_emlrt_marshallIn(SFc10_blokowyInstanceStruct *chartInstance,
  const mxArray *c10_Num, const char_T *c10_identifier, int32_T c10_y[3]);
static void c10_b_emlrt_marshallIn(SFc10_blokowyInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId, int32_T c10_y[3]);
static void c10_c_emlrt_marshallIn(SFc10_blokowyInstanceStruct *chartInstance,
  const mxArray *c10_Sequence, const char_T *c10_identifier, int32_T c10_y[270]);
static void c10_d_emlrt_marshallIn(SFc10_blokowyInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId, int32_T c10_y
  [270]);
static uint8_T c10_e_emlrt_marshallIn(SFc10_blokowyInstanceStruct *chartInstance,
  const mxArray *c10_b_is_active_c10_blokowy, const char_T *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn(SFc10_blokowyInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_blokowyInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c10_blokowy(SFc10_blokowyInstanceStruct *chartInstance)
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  chartInstance->c10_is_active_c10_blokowy = 0U;
}
  ...
  *chartInstance)
{
  ...
  c10_c_u = chartInstance->c10_is_active_c10_blokowy;
  c10_d_y = NULL;
  ...
  const mxArray *c10_st)
{
  ...
  chartInstance->c10_is_active_c10_blokowy = c10_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 2)),
     "is_active_c10_blokowy");
...
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  c10_chartstep_c10_blokowy(chartInstance);
}
...
const mxArray *sf_c10_blokowy_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c10_b_is_active_c10_blokowy, const char_T *c10_identifier)
{
  ...
  c10_y = c10_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_blokowy), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_blokowy);
  return c10_y;
}
...
void sf_c10_blokowy_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2512869440U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2716584424U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(579976166U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3283355820U);
}

mxArray *sf_c10_blokowy_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("QENw0uLwWORvmhdUDNM7C");
...
mxArray *sf_c10_blokowy_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c10_blokowy(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[14],T\"Num\",},{M[1],M[13],T\"Sequence\",},{M[8],M[0],T\"is_active_c10_blokowy\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_blokowy_get_check_sum(&mxChecksum);
...
{
  return "B3wPEW6BpGCfpL7ofLY3LC";
}

static void sf_opaque_initialize_c10_blokowy(void *chartInstanceVar)
{
  initialize_params_c10_blokowy((SFc10_blokowyInstanceStruct*) chartInstanceVar);
  initialize_c10_blokowy((SFc10_blokowyInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_blokowy(void *chartInstanceVar)
{
  enable_c10_blokowy((SFc10_blokowyInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_blokowy(void *chartInstanceVar)
{
  disable_c10_blokowy((SFc10_blokowyInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_blokowy(void *chartInstanceVar)
{
  sf_c10_blokowy((SFc10_blokowyInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_blokowy(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_blokowy((SFc10_blokowyInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_blokowy();/* state var info */
...
extern void sf_internal_set_sim_state_c10_blokowy(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c10_blokowy((SFc10_blokowyInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_blokowy(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_blokowy(S);
}

static void sf_opaque_set_sim_state_c10_blokowy(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c10_blokowy(S, st);
}

static void sf_opaque_terminate_c10_blokowy(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_blokowyInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_blokowy_optimization_info();
    }

    finalize_c10_blokowy((SFc10_blokowyInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_blokowy((SFc10_blokowyInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_blokowy(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c10_blokowy((SFc10_blokowyInstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c10_blokowy(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(407293927U));
  ssSetChecksum1(S,(4192917536U));
  ssSetChecksum2(S,(2237689390U));
  ssSetChecksum3(S,(4274443901U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c10_blokowy(SimStruct *S)
{
...
static void mdlStart_c10_blokowy(SimStruct *S)
{
  SFc10_blokowyInstanceStruct *chartInstance;
  chartInstance = (SFc10_blokowyInstanceStruct *)utMalloc(sizeof
    (SFc10_blokowyInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_blokowyInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_blokowy;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c10_blokowy;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_blokowy;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_blokowy;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_blokowy;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_blokowy;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_blokowy;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c10_blokowy;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_blokowy;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_blokowy;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_blokowy;
...
void c10_blokowy_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_blokowy(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_blokowy(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_blokowy(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_blokowy_method_dispatcher.\n"
